...
//        }
    ...
    public static String getMessage(){
        ...
        return "{\"country\":\"中国\",\"syncTime\":\""+smp.format(new Date())+"\",\"role\":"+getRole()+",\"city\":\"苏州\",\"lon\":120.5954,\"type\":1,\"lib_version\":\"1.0.0\",\"screen_height\":0,\"province\":\"江苏省\",\"event_code\":\""+getEvenCode()+"\",\"browser\":\"\",\"browser_version\":\"\",\"lat\":31.3041,\"screen_width\":0,\"create_time\":"+new Date().getTime()+",\"os\":\"\",\"ip\":\""+getIps().getIp()+"\",\"dept_name\":\"极味鲜\",\"enterprise_id\":0,\"application_id\":"+new Random().nextInt(10)+",\"token\":\"\",\"user_id\":1300,\"location\":{\"lon\":120.5954,\"lat\":31.3041},\"dept_id\":79,\"isWdzSys\":false,\"stay_time\":"+getStaytime()+"}";

    }

    private static int getStaytime(){
