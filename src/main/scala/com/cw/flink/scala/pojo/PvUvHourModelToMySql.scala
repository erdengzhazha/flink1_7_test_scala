...
case class PvUvHourModelToMySql(
                           pv: Int,
                     uv:Int,
                     manager_num_rate:Double,
                     store_manager_num_rate:Double,
                     supervisor_num_rate:Double,
                     application_id: Int,
                     manager_num: Int,
  ...
  override def productElement(n: Int): Any = n match {
    case 0 =>pv: Int
    case 1 => uv:Int
    case 2 => manager_num_rate:Double
    case 3 => store_manager_num_rate:Double
    case 4 => supervisor_num_rate:Double
    case 5 => application_id: Int
    case 6 => manager_num: Int
    case 7 => store_manager_num: Int
    case 8 => supervisor_num: Int
    case 9 => avg_stay_time: Double
    case 10 => hour: Int
